# Varnish (Drupal) service for Kubernetes on Wodby

Run Varnish (Drupal) as a reusable Kubernetes application service with Wodby.

This repository defines the Wodby service manifests and operational
configuration for Varnish (Drupal).
...
Reference `drupal-varnish` from a Wodby stack to use this service.
