# Varnish (Drupal) service for Wodby

Use Varnish (Drupal) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Varnish (Drupal) service in the Wodby catalog.

- [Varnish (Drupal) service in the Wodby catalog](https://wodby.com/services/drupal-varnish)
...
| --- | --- |
| Service name | `drupal-varnish` |
| Type | Application service |
| Inherits from | [`varnish`](https://github.com/wodby/service-varnish) with version constraint `^1.0.0` |
...
4. Reference `drupal-varnish` from your stack manifest.
